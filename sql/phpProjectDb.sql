...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2022 at 11:44 PM
...
ALTER TABLE `incident`
  ...
  ADD KEY `incident_location` (`incident_location`),
  ADD KEY `incident_status_id` (`incident_status_id`),
  ADD KEY `caller_name` (`caller_name`),
  ADD KEY `incident_desc` (`incident_desc`),
...
--
ALTER TABLE `incident`
  ADD CONSTRAINT `incident_ibfk_1` FOREIGN KEY (`incident_id`) REFERENCES `dispatch` (`incident_id`),
  ADD CONSTRAINT `incident_ibfk_2` FOREIGN KEY (`incident_type_id`) REFERENCES `incident_type` (`incident_type_id`),
  ADD CONSTRAINT `incident_ibfk_3` FOREIGN KEY (`incident_status_id`) REFERENCES `incident_status` (`incident_status_id`);
